...
if(isset($_POST['refuser_relation']) AND isset($_GET['id']) AND $_GET['id'] == $_SESSION['id'])
{
    $refuser_relation = $bdd->prepare('DELETE FROM gestion_relations WHERE user_demandeur = :user_demandeur AND user_receveur = :user_receveur ');

    $refuser_relation->execute([
