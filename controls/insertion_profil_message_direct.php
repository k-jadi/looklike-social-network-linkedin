...
<?PHP
    ...
    if (!empty($_POST['message_direct'])){
            ...
            <p style="padding:5px;text-align:center;color:green;font-family:Arial, Helvetica, sans-serif;font-size:0.8rem;font-weight:bold;">Votre message a bien été envoyé.<br><br>Retour dans 3s à la page profil.</p>
            <?PHP
            header('refresh:3;URL=../profil.php?id='.$get_id_correspondant);
    }
?>
</div>
